...
public enum ErrorInfo {
    ...
    MAGAZINE_NOT_FOUND_EXCEPTION(400, 1000, "존재하지 않는 매거진입니다."),
    USER_NOT_FOUND_EXCEPTION(400, 1001, "존재하지 않는 사용자입니다."),
    TATTOO_NOT_FOUND_EXCEPTION(400, 1002, "존재하지 않는 타투입니다."),
    CATEGORY_NOT_FOUND_EXCEPTION(400, 1003, "존재하지 않는 카테고리입니다."),
